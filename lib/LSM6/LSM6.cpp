...
void LSM6::DisableIMU()
{
  // Accelerometer

  //writeReg(DSO_FIFO_CTRL4, 0x00);
  //writeReg(CTRL4_C, 0b0100000);
...
//disable INT pullups: Increase consumption on hibernate 2mA
  //writeReg(CTRL3_C, 0x14);

  // Common

  // 0x04 = 0b00000100
  // IF_INC = 1 (automatically increment register address)
  //writeReg(CTRL3_C, 0x00);
