...
extern "C"
{
    ...
    /* Exported define -----------------------------------------------------------*/
    #define STC3100_ADDRESS 0x70 //E0
...
#define STC3100_REG_RAM30 0x3E
    ...
    public:
        ...
        int STC3100_resetGauge(void);
        int STC3100_Powerdown(void);
        int ReadBatteryData(void);
        bool STC3100_isConnected();
        /* STC3100 variables definition ------------------------------------*/

        int stc3100_getVbat(bool force=0);
        int stc3100_getmAbat(bool force=0);
        short stc3100_getChargeCount(bool force=0);
        int stc3100_getVbat_o();
        int stc3100_getmAbat_o();

        int STC3100_Read(unsigned char ByteCount, unsigned char RegisterAddr, unsigned char *RxBuffer);

        int STC3100_Read_12(unsigned char RegisterAddr, unsigned char *RxBuffer);
        int STC3100_Read_1(unsigned char RegisterAddr, unsigned char *RxBuffer);
